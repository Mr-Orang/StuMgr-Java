...
public class TalkServiceImpl implements ITalkService {
	...
	public PageHelpVO Querytalkclass(Integer page,Integer rows) throws Exception{
		...
		Page<Student> p=PageHelper.startPage(page, rows, true);
	...
	public PageHelpVO QueryClassStudentTalkdetail(Integer page,Integer rows,String emp_id, String tc_name) throws Exception {
		PageHelpVO ph=new PageHelpVO();
		Page<ClassStudentTalkVo> p=PageHelper.startPage(page, rows, true);
	...
	public PageHelpVO QueryStudentTalkrecord(Integer page, Integer rows, String stu_id, String emp_id)
			throws Exception {
		PageHelpVO ph=new PageHelpVO();
		Page<TalkClassStudentVo> p=PageHelper.startPage(page, rows, true);
	...
	@Override
	public LayUiPageInfo QueryStudentTalk(Integer page,Integer rows,String stu_id,String viewpoint) throws Exception {
		LayUiPageInfo layUiPageInfo=new LayUiPageInfo();
		layUiPageInfo.setCode(0);
		Page<TalkClassStudentVo> page1=PageHelper.startPage(page, rows);
		layUiPageInfo.setData(this.talkmapper.QueryStudentTalk(stu_id,viewpoint));
	...
	@Override
	public void UpdateStudentNoAgreeTalk(String talk_details_id,String reason) throws Exception {
		this.talkmapper.UpdateStudentNoAgreeTalk(talk_details_id,reason);
	}
