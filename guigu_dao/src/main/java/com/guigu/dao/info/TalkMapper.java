...
public interface TalkMapper {
	 ...
	 * @throws Exception
	 */
	List<TalkClassStudentVo> QueryStudentTalk(@Param("stu_id")String stu_id,@Param("viewpoint")String viewpoint) throws Exception;
	...
	/**
	 * 根据谈话详情id修改学生确认不同意谈话状态
	 * @param talk_details_id
	 * @throws Exception
	 */
	void UpdateStudentNoAgreeTalk(@Param("talk_details_id")String talk_details_id,@Param("reason")String reason) throws Exception;
}
