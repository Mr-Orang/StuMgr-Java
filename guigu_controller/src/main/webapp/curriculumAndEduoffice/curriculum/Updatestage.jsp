...
<html>
  ...
  <body>
    	<form class="layui-form layui-panel" id="tc_sname" name="tc_sname" action="<%=request.getContextPath()%>/updateStage.action";
	...
	<option value=""></option>
	<option value="可用">0</option>
	<option value="不可用">1</option>
	</select>
	</div>
	</div>
	<div class="layui-form-item">
