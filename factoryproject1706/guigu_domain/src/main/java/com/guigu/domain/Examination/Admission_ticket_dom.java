package com.guigu.domain.Examination;

public class Admission_ticket_dom {
	...
	public Admission_ticket_dom(String adm_id, String stu_id, int adm_state, String apply_id) {
		super();
		this.adm_id = adm_id;
		this.stu_id = stu_id;
		this.adm_state = adm_state;
